...
<head>
	...
	<title><?php echo $row_parea['name']; ?> | Adv Mahbub Alam | Lockers IT Solution</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container">
		<div class="center-heading">
			<h2><i class="fa fa-<?php echo $row_parea['icon']; ?>"></i></h2>
			...
			<div class="col-md-12 margin30">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title text-center"><?php echo $row_parea['name']; ?></h3>
					</div>
					<div class="panel-body text-center"><?php echo $row_parea['details']; ?></div>
				</div>
			</div>
		</div>
	</div><!--container-->
