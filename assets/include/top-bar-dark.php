		...
		<div class="row">
			...
			<div class="col-sm-8 text-right">
				<ul class="list-inline top-dark-right">                      
					<li class="hidden-sm hidden-xs"><i class="fa fa-envelope"></i> <a href="mailto:<?php echo $row_settings['iemail']; ?>"><?php echo $row_settings['iemail']; ?></a></li>
					<li class="hidden-sm hidden-xs"><i class="fa fa-phone"></i> +880-<?php echo substr($row_settings['phone'], 1, 4); ?>-<?php echo substr($row_settings['phone'], 5, 10); ?></li>
					<?php
