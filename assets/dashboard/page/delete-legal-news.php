...
<?php
	if(isset($_POST['del'])){
		$ID = $_POST['confirm'];
		$sql = $connection->query("delete from lnews where id='$ID'");
		header('Location: dashboard.php?page=legal-news');
	}
?>
<head>
	<?php include"assets/include/tag.php"; ?>
	<title>Delete Legal News | Adv Mahbub Alam | Lockers IT Solution</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="breadcrumb-wrap">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<h4>Delete Legal News</h4>
				</div>
				<div class="col-sm-6 hidden-xs text-right">
					<ol class="breadcrumb">
						<li><a href="dashboard.php?page=home">Home</a></li>
						<li><a href="dashboard.php?page=legal-news">All Legal News</a></li>
					...
					<fieldset>	
						<section>
							<div class="team-wrap">
								...
								<input type="checkbox" name="confirm" id="confirm" value="<?php echo $row_lnews["id"]; ?>" required >Yes! I want to delect <?php echo $row_lnews["name"]; ?>.
							</div><!--team-wrap-->
						</section>
					</fieldset>
					<footer>
						<a href="dashboard.php?page=legal-news" class="btn btn-theme-bg btn-ico btn-lg"><i class="fa fa-reply"></i> Cancel</a>
						<button type="submit" name="del" id="del" class="btn btn-theme-bg btn-lg pull-right">Delete it!  <i class="fa fa-trash"></i></button>
					</footer>
					<div class="message">
						<i class="fa fa-check"></i>
						<p>Legal News delete successfully.</p>
