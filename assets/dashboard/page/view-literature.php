...
<head>
	...
	<title>View Literature | Adv Mahbub Alam | Lockers IT Solution</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="breadcrumb-wrap">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<h4>View Literature</h4>
				</div>
				<div class="col-sm-6 hidden-xs text-right">
					<ol class="breadcrumb">
						<li><a href="dashboard.php?page=home">Home</a></li>
						<li class="active">All Literature</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="container mas-boxes">
			<?php do { ?>
				<div class="mas-boxes-inner">
					<!--<img src="assets/img/literature/<?php echo $row_literature['image']; ?>" alt="<?php echo $row_literature['name']; ?>" class="img-responsive">-->
					<div class="mas-blog-inner">
						<h3><a href="view-literature.php?id=<?php echo $row_literature['id']; ?>" target="_blank"><?php echo $row_literature['name']; ?></a></h3>
						...
						<ul class="list-inline">
							<li>
								<a href="dashboard.php?page=update-literature&id=<?php echo $row_literature['id']; ?>" class="btn btn-theme-bg btn-ico btn-sm pull-left">Change <i class="fa fa-edit"></i></a>
							</li>
							<li>
								<a href="dashboard.php?page=delete-literature&id=<?php echo $row_literature['id']; ?>" class="btn btn-danger btn-ico btn-sm pull-right">Delete  <i class="fa fa-trash"></i></a>
							</li>
						</ul><!--social-->
					</div><!--blog inner-->
				</div>
