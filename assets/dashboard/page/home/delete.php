	...
	<div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2 margin30 sky-form-columns contact-sky-option">
		<form action="" method="post" id="sky-form" class="sky-form sky-form-columns">
			<fieldset>	
				<section>
					<div class="team-wrap">
						...
						<input type="checkbox" name="confirm" id="confirm" value="<?php echo $row_usere["id"]; ?>" required >Yes! I want to delect <?php echo $row_usere["name"]; ?>.
					</div><!--team-wrap-->
				</section>
			</fieldset>
			<footer>
				<a href="dashboard.php?page=user" class="btn btn-theme-bg btn-ico btn-lg"><i class="fa fa-reply"></i> Cancel</a>
			...
			<div class="message">
				...
				<p><a href="dashboard.php?page=user">Back to Users.</a></p>
			</div>
		</form>					
	</div>
</div>