...
<?php
	...
	if(isset($_POST['update'])){
		...
		$Status = $_POST['status'];
		$sql = $connection->query("UPDATE cases set fday='{$Fday}', badi='{$Badi}', side='{$Side}', lday='{$Lday}', type='{$Type}', thana='{$Thana}', event='{$Event}', court='{$Court}', details='{$Details}', status='{$Status}' where id='$ID'");// value insert into database
	}
?>
<head>
	<?php include"assets/include/tag.php"; ?>
	<title>Update Case | Adv Mahbub Alam | Lockers IT Solution</title>
	<!-- Bootstrap -->
		...
		<div class="row">
			<div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2 margin30 sky-form-columns contact-sky-option">
				<form action="" method="post" id="sky-form" class="sky-form sky-form-columns">
					<fieldset>	
						<p class="margin30">Update Case</p>
						<section>
							<label class="label">পূর্ব তারিখ  *</label>
							<label class="input">
								<i class="icon-append fa fa-calendar"></i>
								<input type="text" name="fday" id="fday" value="<?php echo $row_cases['fday'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								...
								<input type="text" name="badi" id="badi" value="<?php echo $row_cases['badi'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								...
								<input type="text" name="side" id="side" value="<?php echo $row_cases['side'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								<i class="icon-append fa fa-calendar"></i>
								<input type="text" name="lday" id="lday" value="<?php echo $row_cases['lday'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								...
								<input type="text" name="type" id="type" value="<?php echo $row_cases['type'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								...
								<input type="text" name="thana" id="thana" value="<?php echo $row_cases['thana'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								...
								<input type="text" name="event" id="event" value="<?php echo $row_cases['event'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="input">
								...
								<input type="text" name="court" id="court" value="<?php echo $row_cases['court'] ?>" required>
							</label>
						</section>
						<section>
							...
							<label class="textarea">
								...
								<textarea rows="4" name="details" id="details"><?php echo $row_cases['details'] ?></textarea>
							</label>
						</section>
						<section>
							<label class="label">বর্তমান আবস্থা : <?php if($row_cases['status']=='active'){echo 'খোলা';}else{ echo 'বন্ধ';} ?></label>
