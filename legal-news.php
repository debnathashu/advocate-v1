...
<head>
	...
	<title>Legal News | Adv Mahbub Alam | Lockers IT Solution</title>
	<!-- Bootstrap -->
			...
			<?php do { ?>
				<div class="mas-boxes-inner">
					...
					<div class="mas-blog-inner">
						<h3><a href="view-legal-news.php?id=<?php echo $row_lnews['id']; ?>"><?php echo $row_lnews['name']; ?></a></h3>
						...
						<a href="view-legal-news.php?id=<?php echo $row_lnews['id']; ?>">Continue reading</a>
					</div><!--blog inner-->
				</div>
