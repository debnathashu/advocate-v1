...
<head>
	...
	<title><?php echo $row_literature['name']; ?> | Literature | Adv Mahbub Alam | Lockers IT Solution</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="breadcrumb-wrap">
		<div class="container">
			<div class="row">
				<div class="col-sm-8">
					<h4><?php echo $row_literature['name']; ?></h4>
				</div>
				<div class="col-sm-4 hidden-xs text-right">
					<ol class="breadcrumb">
						<li><a href="index.php">Home</a></li>
						<li><a href="literature.php">Literature</a></li>
						<li class="active">View Literature</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div id="testi-carousel" class="owl-carousel owl-spaced">
					<div>
						<img src="img/legal-news/<?php echo $row_lnews['image']; ?>" class="img-responsive" alt="">
					</div>
				</div>
			</div>
		</div><!--img slide row-->
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="project-detail">
					<h3><?php echo $row_literature['name']; ?></h3>
